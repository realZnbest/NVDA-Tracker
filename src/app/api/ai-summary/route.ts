...
2. ตามด้วยรายการ 3-4 ข้อ แต่ละข้อขึ้นต้นด้วย "- " และขึ้นบรรทัดใหม่ ครอบคลุมหัวข้อเหล่านี้ตามลำดับ (ข้ามหัวข้อที่ไม่มีข้อมูล): รายได้และการเติบโต, กำไรและอัตรากำไร, กระแสเงินสดอิสระ, อัตราส่วนมูลค่า (P/E, P/S)
...
ผลประกอบการล่าสุดของ NVIDIA เติบโตต่อเนื่องจากความต้องการชิป AI ที่แข็งแกร่งครับ
- รายได้: เติบโต X% เทียบปีก่อน แตะระดับ $X
- กำไร: กำไรสุทธิ $X อัตรากำไรสุทธิ X%
- กระแสเงินสดอิสระ: $X
- มูลค่าหุ้น: P/E อยู่ที่ X เท่า`;
}
