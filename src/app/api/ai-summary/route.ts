...
const TONE_INSTRUCTION =
  "โทนแบบเพื่อนผู้ชายสนิทคุยกันเรื่องหุ้น ชิลๆ ตรงไปตรงมา ห้วนกระชับแบบผู้ชาย ไม่ต้องหวือหวา ไม่ใช้คำอุทานหรือคำลงท้ายแบบดราม่าเวอร์วัง พูดตรงประเด็นเหมือนเล่าให้เพื่อนฟังสั้นๆ ใช้ 'ครับ' ปิดท้ายพอเป็นมารยาท ไม่ต้องใส่ทุกประโยค";
...
เขียนสรุปภาษาไทย 2-3 ประโยค ${TONE_INSTRUCTION} (ตัวอย่างสไตล์: "ไตรมาสนี้ชิป AI ขายดีจนงบโตแรง แต่ต้องจับตา Supply Chain ต่อ") ใช้เฉพาะตัวเลขที่ให้มาเท่านั้น ห้ามเดาหรือแต่งตัวเลขเพิ่ม ห้ามให้คำแนะนำการลงทุน (เช่น ควรซื้อ/ควรขาย) ตอบเป็นข้อความล้วน ไม่ต้องมีหัวข้อหรือ bullet`;
}
...
เขียนสรุปภาษาไทย 2-4 ประโยค ${TONE_INSTRUCTION} จับประเด็นสำคัญที่ข่าวหลายชิ้นพูดตรงกัน ใช้เฉพาะข้อมูลที่ให้มาเท่านั้น ห้ามเดาหรือแต่งเพิ่ม ห้ามให้คำแนะนำการลงทุน ตอบเป็นข้อความล้วน ไม่ต้องมีหัวข้อหรือ bullet`;
}
