...
เขียนสรุปภาษาไทย 2-3 ประโยค ${TONE_INSTRUCTION} (ตัวอย่างสไตล์: "ไตรมาสนี้รายได้จากกลุ่มชิป AI เติบโตอย่างมีนัยสำคัญ ส่งผลให้ผลประกอบการโดยรวมปรับตัวดีขึ้น อย่างไรก็ตามยังคงต้องติดตามความเสี่ยงด้านห่วงโซ่อุปทานอย่างใกล้ชิด") ใช้เฉพาะตัวเลขที่ให้มาเท่านั้น ห้ามเดาหรือแต่งตัวเลขเพิ่ม ห้ามให้คำแนะนำการลงทุน (เช่น ควรซื้อ/ควรขาย) ตอบเป็นข้อความล้วน ไม่ต้องมีหัวข้อหรือ bullet`;
}
